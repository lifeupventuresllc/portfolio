...
export const FUNNEL_NURTURE_SEQUENCE: FollowUpStep[] = [
  ...
  },
  {
    ...
    text: (firstName, service) => isFit(service)
      ? `Hey ${firstName},\n\nStill haven't made an account? The Life-Up Fitness app is 100% free — custom workouts, done-for-you meals, Coach Asa checking in on you, the whole thing.\n\nNo trial to track, no card, nothing to cancel later.\n\nCreate your account: ${CHALLENGE_URL}\n\nOr just reply and tell me what's holding you back — I'll help.\n\n— Asa Luke`
    ...
    html: (firstName, service) => isFit(service)
      ? wrap(`<p>Hey ${firstName},</p><p>Still haven't made an account? The <strong>Life-Up Fitness app is 100% free</strong> — custom workouts, done-for-you meals, Coach Asa checking in on you, the whole thing.</p><p>No trial to track, no card, nothing to cancel later.</p>${btn(CHALLENGE_URL, 'Create your free account →')}<p>Or just reply and tell me what's holding you back — I'll help.</p>`)
