    ...
    <div className="min-h-screen bg-obsidian">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-ivory/60 max-w-lg mx-auto">An AI-ready prompt that writes your captions, headlines &amp; on-screen text — plus a 7-step system for scroll-stopping Reels. By Asa Luke.</p>
        </div>
