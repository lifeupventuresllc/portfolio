...
const TIERS = [
  {
    features: [
      '1 track mix & master',
      'Full stem mixing',
      'Professional EQ, compression & effects',
      'Reference track matching',
      'Delivered in WAV 24-bit + MP3 320kbps',
      'File preparation guide (how to export stems correctly)',
      'Streaming-ready format (optimized for Spotify, Apple Music, etc.)',
      '2 revisions included',
      '48-hour turnaround',
    ],
    guarantee: "Not happy with the mix? I'll revise until you are. If I can't get the sound you want, full refund.",
  },
  {
    features: [
      ...
      'Distribution checklist (DistroKid/TuneCore step-by-step)',
      'Release day promotion checklist',
      '2 revisions per track',
      '5-day turnaround',
    ],
    guarantee: "Not happy? Unlimited revisions until you love it. Full refund if I can't match your reference sound. Plus: 1 free bonus mix if you're not satisfied with the EP quality.",
  },
  {
    features: [
      '6-12 tracks mix & master',
      'Full project consistency & cohesion',
      'Creative direction session (1 hour)',
      'Full stem mixing',
      'Professional EQ, compression & effects',
      'Reference track matching',
      ...
      'Distribution checklist (DistroKid/TuneCore step-by-step)',
      'Release day promotion checklist',
      'Album sequencing consultation (track order for best listening experience)',
      'Pre-save campaign template',
      'Unlimited revisions',
      '10-day turnaround',
    ],
    guarantee: "100% money-back guarantee, no questions asked. Unlimited revisions. If the final master doesn't match industry quality, you don't pay. Plus: 2 free bonus mixes and a free creative direction session if you're not completely satisfied.",
  },
]
