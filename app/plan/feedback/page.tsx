  ...
  return (
    <div className="min-h-screen bg-paper px-4 py-12">
      <div className="max-w-lg mx-auto">
        ...
        <h1 className="text-3xl font-bold text-ink mb-2">How&apos;s the app treating you?</h1>
        <p className="text-ink/60 text-sm mb-8">Something broke, felt confusing, or you love it — tell me. I read every one myself.</p>
        <FeedbackForm />
      </div>
    </div>
  )
