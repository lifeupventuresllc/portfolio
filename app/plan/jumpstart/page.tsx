  ...
  return (
    <div className="min-h-screen bg-paper px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-ink mb-2">The 7-Day Jump Start</h1>
        <p className="text-ink/60 text-sm mb-8">Before we go all-in, {firstName}, let&apos;s stack a few quick wins so you feel momentum fast. One focus a day — that&apos;s it. Do these and you&apos;ll feel different by the weekend.</p>
