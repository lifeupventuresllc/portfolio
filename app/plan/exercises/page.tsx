  ...
  return (
    <div className="min-h-screen bg-paper px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-ink mb-2">Every move in your training</h1>
        <p className="text-ink/60 text-sm mb-8">Browse and search every exercise across gym, abs, and home — how to do it, what it targets.</p>
        <MoveBrowser />
      </div>
    </div>
  )
